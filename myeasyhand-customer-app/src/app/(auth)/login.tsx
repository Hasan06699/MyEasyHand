    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: theme.primary }]}>
      <KeyboardAvoidingView
        ...
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          ...
          <Text style={[styles.heading, { color: theme.textHighContrast }]}>Login</Text>
          ...
          <Button label="Login" onPress={handleLogin} loading={isLoading} />

          <View style={styles.footer}>
            <Text style={[styles.footerText, { color: theme.textLowContrast }]}>
              Don&apos;t have an account?{' '}
            </Text>
            <Link href="/(auth)/register" asChild>
              <Pressable>
                <Text style={[styles.link, { color: theme.accent }]}>Create here</Text>
              </Pressable>
            </Link>
          </View>
        </ScrollView>
